      ...
      <main className="p-4 space-y-6">
        ...
        <Card>
          <CardContent className="divide-y divide-slate-100 p-0">
             <Link href="/worker/contracts/1" className="flex items-center justify-between p-4 hover:bg-slate-50">
             ...
             <Link href="/worker/paystubs" className="flex items-center justify-between p-4 hover:bg-slate-50">
                <div className="flex items-center gap-3">
                   ...
                   <div className="flex items-center gap-2">
                     <div
                       className={`h-2 w-2 rounded-full ${
                         doc.status === "submitted" ? "bg-teal-500" : "bg-slate-300"
                       }`}
                     ></div>
