    ...
    <MobileLayout title="일용직 근로자 등록" showBack>
      <div className="p-4 space-y-6">
        <div className="space-y-2">
          <label className="text-sm font-medium text-slate-900">신분증/안전교육증 촬영</label>
          <div className="grid grid-cols-2 gap-3">
            <Button variant="secondary" className="h-32 flex-col gap-2 border-dashed">
        ...
        <div className="space-y-4">
          ...
          <div>
            <label className="text-sm font-medium text-slate-900">주민등록번호</label>
            <div className="flex gap-2 items-center">
              ...
              <div className="mt-1 w-full flex gap-1">
                 <input 
                  ...
                  maxLength={1}
                />
                <span className="flex-1 rounded-lg bg-slate-100 py-2 text-slate-400 px-2">******</span>
              </div>
            </div>
          </div>

          <div>
            <label className="text-sm font-medium text-slate-900">계좌번호</label>
