...
import { Card, CardContent, Button, StatusBadge } from "@yunigreen/ui"
import { formatRelativeTime } from "@yunigreen/ui"
  ...
  return (
    <MobileLayout title="프로젝트">
      <div className="space-y-4 p-4">
        ...
        {isLoading ? (
          ...
          <Card>
            <CardContent className="p-6 text-center">
              <p className="text-slate-500">프로젝트를 불러오는 데 실패했어요</p>
        ...
        <Link
          href="/projects/new"
          className="fixed bottom-20 right-4 flex h-14 w-14 items-center justify-center rounded-full bg-teal-500 text-white shadow-lg hover:bg-teal-600"
        >
