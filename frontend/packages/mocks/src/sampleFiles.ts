...
export const PROJECT_DOCUMENT_SAMPLE_MANIFEST: Record<string, string> = {
  ...
  c2: "sample/1. 관공서 계약서류/2. 수의계약체결제한여부확인서_연동경로당 외 1개소(성산1동 제2경로당) 도장 및 방수공사.hwpx",
  c3: "sample/1. 관공서 계약서류/3. 시방서_연동경로당 외 1개소(성산1동 제2경로당) 도장 및 방수공사.hwpx",
  c4: "sample/1. 관공서 계약서류/4. 사업자외 서류_(주)유니그린개발.pdf",
  c5: "sample/1. 관공서 계약서류/5. 계약보증서_대경중학교 본관동 균열보수공사.pdf",
  c6: "sample/1. 관공서 계약서류/5-1. 계약보증금 지급각서.hwpx",
  m1: "sample/2. 관공서 착공서류/0. 착공공문.hwpx",
  m2: "sample/2. 관공서 착공서류/1. 착공신고서.hwpx",
  m3: "sample/2. 관공서 착공서류/2. 재직증명서_이시대(현장대리인).hwpx",
  "m3-1": "sample/2. 관공서 착공서류/2. 재직증명서_이시대(현장대리인).hwpx",
  "m3-2": "sample/2. 관공서 착공서류/2. 재직증명서_이시대(현장대리인).hwpx",
  "m3-3": "sample/2. 관공서 착공서류/2. 재직증명서_이시대(현장대리인).hwpx",
  m4: "sample/2. 관공서 착공서류/3. 계약내역서_하하호호 장난감도서관 잠실점 방수공사.xlsx",
  m5: "sample/2. 관공서 착공서류/4. 노무비 관련 서류.hwpx",
  m6: "sample/2. 관공서 착공서류/5. 안전보건관리 준수 서약서.hwpx",
  m7: "sample/2. 관공서 착공서류/6. 착공 전 사진.hwpx",
  m8: "sample/2. 관공서 착공서류/7. 직접시공계획서.hwpx",
  m9: "sample/2. 관공서 착공서류/8. 안전보건관리계획서(산업안전보건관리비 사용계획서 포함).hwpx",
  s1: "sample/7. 공사일지/공사일지_방배중 외1교(역삼중)균열보수공사_25.08.08.hwpx",
  s2: "sample/5. 일용신고 서류/서울시+건설일용근로자+표준근로계약서(2019.2_개정_서울계약마당).hwpx",
  s3: "sample/8. 누수소견서(현장 점검 보고서)/1. 현장 점검 보고서_합격의 법학원.xlsx",
  p1: "sample/3. 관공서 준공서류/0. 준공공문.hwpx",
  p2: "sample/3. 관공서 준공서류/1. 준공계.hwpx",
  ...
  l3: "sample/5. 일용신고 서류/서울시+건설일용근로자+표준근로계약서(2019.2_개정_서울계약마당).hwpx",
  v1: "sample/6. 민간 계약관련 서류(간단)/1. 공사도급표준계약서(공사 전 계약에 필요한 서류).hwpx",
  h1: "sample/9. 학교 서류/공사서류 원클릭 프로그램(2025.3.수정)-서울시교육청용.xlsm",
  h2: "sample/9. 학교 서류/1. 수도전기공문.hwpx",
};
