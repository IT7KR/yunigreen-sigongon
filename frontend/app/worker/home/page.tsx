  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const [profileRes, contractsRes, paystubsRes, notificationsRes] =
        await Promise.all([
          (api as any).getWorkerProfile(user?.id ?? ""),
          (api as any).getWorkerContracts(user?.id ?? ""),
          (api as any).getWorkerPaystubs(user?.id ?? ""),
      ...
      <div className="space-y-6 p-4">
        ...
        <div>
          ...
          {isLoading ? (
            ...
            <AppLink href={`/worker/contracts/${latestContract.id}`}>
        ...
        <div>
          ...
          {isLoading ? (
            ...
            <AppLink href={`/worker/paystubs/${latestPaystub.id}`}>
