...
> 유니그린 SaaS(시공코어) 프로젝트의 확정사항, 변경사항, 오픈 이슈, 실행 ToDo를 단일 문서로 관리합니다.
...
| 4   | 2026-01-21 | 킥오프 1차            | 서비스명 시공코어, 업무 프로세스 상세화, 권한 초안, 토스페이먼츠    | `docs/project-management/meeting/20260121_meeting.md`         |
...
| 확정 내용                                                                                     | 적용 기준일 | 상태 | 출처                                                          |
| --------------------------------------------------------------------------------------------- | ----------: | ---- | ------------------------------------------------------------- |
| 서비스명은 **시공코어**으로 사용                                                              |  2026-01-21 | 유효 | `docs/project-management/meeting/20260121_meeting.md`         |
...
_본 문서는 시공코어 프로젝트의 의사결정 단일 기준 문서입니다. 다음 미팅(2026-02-20) 이후 즉시 v2.2로 갱신합니다._
