...
본 문서는 시공코어 플랫폼의 각 기능별 상세 명세를 정의합니다. API 연동, 비즈니스 로직, 데이터 흐름을 포함합니다.
...
Request:
{
  ...
  "webhook_url": "https://api.sigongcore.com/webhooks/modusign"
}
...
const payment = await tossPayments.requestPayment("카드", {
  ...
  orderName: "시공코어 Basic 월간 구독",
  customerName: "홍길동",
  successUrl: "https://sigongcore.com/payment/success",
  failUrl: "https://sigongcore.com/payment/fail"
});
